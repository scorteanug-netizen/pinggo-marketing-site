...
const flowMessages = [
  {
    side: "left" as const,
    text: "Salut! Vrei o programare pentru consultație?",
  },
  {
    side: "right" as const,
    text: "Da, ideal mâine după-amiază.",
  },
  {
    side: "left" as const,
    text: "Perfect. Am slot la 14:00 sau 16:30.",
  },
  {
    side: "right" as const,
    text: "16:30 e perfect.",
  },
  {
    side: "left" as const,
    text: "Programat. Confirmarea a fost trimisă.",
  },
];
